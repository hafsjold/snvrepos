...
-----END RSA PRIVATE KEY-----";
        ...
        static string HttpGet(string url)
        {
            ...
            success = rsa.UnlockComponent("HAFSJORSA_K36nxU3n1Yui");
            success = rsa.ImportPrivateKey(pkey.GetXml());
            rsa.EncodingMode = "base64";
            rsa.Charset = "ANSI";
            rsa.LittleEndian = false;
            rsa.OaepPadding = false;
            string hexSig = rsa.SignStringENC(Token, "sha-1");


            //VERIFY
            Chilkat.Cert cert = new Chilkat.Cert();
            success = cert.LoadFromBase64(mycert);
