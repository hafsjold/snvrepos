    ...
    public partial class frmBackup : Form
    {
        ...
        private string execZip()
        {
            ...
            try
            {
                ...
                if (codeExit == 0)
                {
                    WriteToEventLog("BackupHDA ended normaly", EventLogEntryType.Information, 49101);
                }
                else
                {
                    WriteToEventLog("BackupHDA Error-1", EventLogEntryType.Error, 49102);
                }
            }
            catch
            {
                WriteToEventLog("BackupHDA Error-2", EventLogEntryType.Error, 49103);
            }
            return Target;
