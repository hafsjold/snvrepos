...
{include file="Test/LobUserTilmeldingHeading.tpl" step="5"}
<div class="pagepuls3060">
  ...
  <p> {$tilmelding->afhente_dit_loebsnummer} L&oslash;bsafgiften p&aring; kr. 
    {$tilmelding->lobsafgift} vil blive h&aelig;vet p&aring; dit Dankort dagen 
