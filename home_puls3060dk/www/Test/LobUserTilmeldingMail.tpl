...
Vi har registreret følgende oplysninger i forbindelse med din tilmelding:
  ...
  Løbsafgift..: {$tilmelding->lobsafgift}
  Kortnummer..: {$tilmelding->cardnumber}

{$tilmelding->afhente_dit_loebsnummer}

Løbsafgiften på kr. {$tilmelding->lobsafgift}vil blive hævet på; dit Dankort dagen efter løbet. 
