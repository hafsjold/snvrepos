...
<?
	...
	$Query = "SELECT Udgivet, 
			  ...
			  ORDER BY Udgivet DESC, Id DESC";
	$dbResult = pg_query($dbLink, $Query);
?>
      <p align=left><font color=#003399 size=4>Puls 3060 M&oslash;der</font></p>
      <table>
        <tr style=background-color:#FF0000><font color=#003399> 
          <th align=center>Dato</th>
          <th align=left>M&oslash;de</th>
        </font></tr>
<?
...
?>
      <tr valign=top style=background-color:<?=getcolor();?>>
        ...
        <td><a href=<?=$row["link"];?> target=<?=gettarget($row["newwindow"]);?>><?=nl2br($row["titel"]);?></a></td>
      </tr>
<?
	}
?>
