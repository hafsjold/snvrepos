...
{include file="Kalender/AktUserTilmeldingHeading1.tpl" step="1"}
<div class="pagepuls3060">
  ...
  <p>Du skal ogs&aring; bruge et Dankort eller eDankort til betaling af deltagerafgiften.</p>
  <p>Deltagerafgiften er {$tilmelding->aktafgift|string_format:"%d DKK"}.</p>
  <form method="post" action="{$SCRIPT_NAME}?DoWhat=11">
    <div class="clslvl1">
      <div class="clslvl2L">
      </div>
      <div class="clslvl2M">
