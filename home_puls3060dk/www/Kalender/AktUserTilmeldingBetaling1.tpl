...
{include file="Kalender/AktUserTilmeldingHeading1.tpl" step="4"}
<div class="pagepuls3060">
  <h3>{$tilmelding->aktnavn} {$tilmelding->aktdato|date_format:"%A den %e. %B kl %H.%M"}</h3>
  <p> Udfyld nedenst&aring;ende fra dit Dankort for at betale deltagerafgiften 
    og trykke p&aring; &quot;N&aelig;ste side&quot;.</p>

  <form method="post" action="{$SCRIPT_NAME}?DoWhat=14">
  ...
  <div class="clslvl1">
    ...
    <div class="clslvl2M">
      {$tilmelding->aktafgift|string_format:"%d DKK"}
    </div>
  </div>
  <div class="clslvl1">
    <div class="clslvl2L">
