...
{include file="Kalender/AktUserTilmeldingHeading1.tpl" step="5"}
<div class="pagepuls3060">
  ...
  <div class="clslvl1">
    <div class="clslvl2L"> Deltagersafgift: </div>
    <div class="clslvl2M">
      <p>{$tilmelding->aktafgift|string_format:"%d DKK"}</p>
    </div>
  </div>
  <div class="clslvl1">
    <div class="clslvl2L">
  ...
  <p>Deltagerafgiften p&aring; 
    {$tilmelding->aktafgift|string_format:"%d DKK"} vil blive h&aelig;vet p&aring; dit Dankort dagen 
    efter tilmeldingsfristens udl&oslash;b.</p>
