...
{include file="pbstest/LobUserTilmeldingHeading.tpl" step="1"}
<div class="pagepuls3060">
  ...
  <p>Du skal ogs&aring; bruge et Dankort eller eDankort til betaling af l&oslash;bsafgiften.</p>
  <p>L&oslash;bsafgifter er {$tilmelding->lobsafgift_voksne()|string_format:"%d DKK"}. <br>
    Hvis du er under 15 &aring;r (f&oslash;dt i {$tilmelding->fodtaar()} eller senere) er l&oslash;bsafgifte 
    {$tilmelding->lobsafgift_unge()|string_format:"%d DKK"}.<br>
  </p>
