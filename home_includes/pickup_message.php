 ...
 * pickup_message.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/mimemessage/pickup_message.php,v 1.3 2004/09/22 21:21:31 mlemos Exp $
 *
 *
 */
...
<class>
	...
	<version>@(#) $Id: pickup_message.php,v 1.3 2004/09/22 21:21:31 mlemos Exp $</version>
...
{metadocument}
	<variable>
		...
		<value>pickup $Revision: 1.3 $</value>
		<documentation>
...
{/metadocument}
*/
	var $mailer_delivery='pickup $Revision: 1.3 $';
	...
	Function SendMessageHeaders($headers)
	{
		...
		if(!$date_set)
			$header_data.="Date: ".strftime("%a, %d %b %Y %H:%M:%S %Z").$this->line_break;
		if(!$message_id_set
