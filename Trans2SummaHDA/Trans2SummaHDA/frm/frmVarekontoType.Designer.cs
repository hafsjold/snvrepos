namespace Trans2SummaHDA
{
    partial class FrmVarekontoType
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.tblvareomkostningerBindingSource.DataSource = typeof(Trans2SummaHDA.tblvareomkostninger);
            // 
            ...
            this.ClientSize = global::Trans2SummaHDA.Properties.Settings.Default.FrmVarekontoTypeSize;
            ...
            this.DataBindings.Add(new System.Windows.Forms.Binding("Location", global::Trans2SummaHDA.Properties.Settings.Default, "FrmVarekontoTypeLocation", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            this.DataBindings.Add(new System.Windows.Forms.Binding("ClientSize", global::Trans2SummaHDA.Properties.Settings.Default, "FrmVarekontoTypeSize", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            this.Location = global::Trans2SummaHDA.Properties.Settings.Default.FrmVarekontoTypeLocation;
