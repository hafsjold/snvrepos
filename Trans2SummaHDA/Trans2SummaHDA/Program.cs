    ...
    static class Program
    {
        public static string ConnectStringWithoutPassword
        {
            get
            {
                ...
                {
#if (DEBUG)
                    m_ConnectStringWithoutPassword = global::Trans2SummaHDA.Properties.Settings.Default.dbDataTransSummaConnectionString;
#else
                    m_ConnectStringWithoutPassword = global::Trans2SummaHDA.Properties.Settings.Default.dbDataTransSummaConnectionString;
#endif
                }
        ...
        static void Main()
        {
            System.Diagnostics.Process[] p = System.Diagnostics.Process.GetProcessesByName("Trans2SummaHDA");
            if (p.Length > 1)
            {
