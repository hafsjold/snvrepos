...
namespace nsPuls3060
{
    ...
    partial void InsertTempimpexp(Tempimpexp instance);
    partial void UpdateTempimpexp(Tempimpexp instance);
    partial void DeleteTempimpexp(Tempimpexp instance);
    ...
    partial void InsertTempsync2(Tempsync2 instance);
    partial void UpdateTempsync2(Tempsync2 instance);
    partial void DeleteTempsync2(Tempsync2 instance);
    #endregion
		...
		public System.Data.Linq.Table<Tempimpexp> Tempimpexp
		{
			get
			{
				return this.GetTable<Tempimpexp>();
			}
		}
		...
		public System.Data.Linq.Table<Tempsync2> Tempsync2
		{
			get
			{
				return this.GetTable<Tempsync2>();
			}
		}
	}
	...
	[Table(Name="tempimpexp")]
	public partial class Tempimpexp : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnActChanged();
		...
		[Column(Name="ie", Storage="_Ie", DbType="NVarChar(1) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string Ie
		{
			get
			{
		...
		[Column(Name="act", Storage="_Act", DbType="NVarChar(3)")]
		public string Act
		{
			get
			{
	...
	[Table(Name="tempsync2")]
	public partial class Tempsync2 : INotifyPropertyChanging, INotifyPropertyChanged
	{
