...
namespace nsPuls3060
{
    ...
    public partial class DataGridViewPlus : DataGridView
    {
        ...
        [Category("Behavior"), DefaultValue(false), Description("Enable or disable drag/drop functionality.")]
        ...
        [Category("Behavior"), DefaultValue(false), Description("Enable or disable drag selection of rows.  Disabling this will make dragging of unselected rows smoother.")]
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            if (_enableDragDrop)
            {
                ...
                if (
                    row >= 0 &&
                    row < this.Rows.Count &&
                    (_suppressDragSelection ||
                    this.SelectedRows.Contains(this.Rows[row]))
                    )
                {
                    _clickedRow = row;
