...
namespace nsPuls3060
{
    public partial class FrmMain : Form
    {
        ...
        private void excelInternt()
        {
            ...
            var MedlemmerAll = from h in Program.dbData3060.tblMedlem
            ...
            using (new ExcelUILanguageHelper())
            {
                try
                {
                    ...
                    this.MainformProgressBar.Maximum = (from h in Program.dbData3060.tblMedlem select h).Count();
        ...
        private void ecxelPoster()
        {
            ...
            var erMedlem = from h in Program.dbData3060.tblMedlem
                           where h.Status == 1
                           select h;
