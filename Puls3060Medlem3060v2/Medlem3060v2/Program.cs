...
namespace nsPuls3060v2
{
    ...
    {
        private static dbData3060 m_dbData3060DataContext;
        ...
        public static dbData3060 dbData3060DataContextFactory()
        {
            string constr = nsPbs3060v2.clsConnectionstringManager.EFConnection;
            return new dbData3060(constr);
        }
        ...
        public static IQueryable<clsLog> qryLog()
        {
            ...
            var qryLogResult = from m in Program.dbData3060.vMedlemLog
                               select new clsLog
                               {
                                   Id = (int?)m.id,
                                   Nr = (int?)m.Nr,
