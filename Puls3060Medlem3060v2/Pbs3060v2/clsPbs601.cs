...
namespace nsPbs3060v2
{
    ...
    public class clsPbs601
    {
        ...
        public Tuple<int, int> advis_auto(dbData3060 p_dbData3060)
        {
            int lobnr = 0;
            string wadvistekst = "";
            int winfotekst;
        ...
        public void advis_email(dbData3060 p_dbData3060, int lobnr)
        {
            int wleveranceid;
            int? wSaveFaknr;
            ...
            var rstdebs = from k in p_dbData3060.tblMedlem
        ...
        public Tuple<int, int> rykker_auto(dbData3060 p_dbData3060)
        {
            int lobnr = 0;
            string wadvistekst = "";
            int winfotekst = 0;
            ...
            var rstmedlems = from h in p_dbData3060.tblMedlem
                             join f in p_dbData3060.tblfak on h.Nr equals f.Nr
                             where f.SFaknr == null &&
                                   f.rykkerstop == false &&
        ...
        public Tuple<int, int> rykkere_bsh(dbData3060 p_dbData3060)
        {
            int lobnr;
            string wadvistekst = "";
            int winfotekst;
            ...
            bool? wbsh = (from h in p_dbData3060.tempRykkerforslag select h.bsh).First();
            ...
            var rstmedlems = from k in p_dbData3060.tblMedlem
                             join l in p_dbData3060.tempRykkerforslaglinie on k.Nr equals l.Nr
                             join f in p_dbData3060.tblfak on l.faknr equals f.faknr
                             join h in p_dbData3060.tempRykkerforslag on l.Rykkerforslagid equals h.id
                             select new
                             {
                                 k.Nr,
                                 k.Navn,
        ...
        public Tuple<int, int> kontingent_fakturer_auto(dbData3060 p_dbData3060)
        {
            int lobnr = 0;
            string wadvistekst = "";
            int winfotekst = 0;
            ...
            var qry_medlemmer = from h in p_dbData3060.tblMedlem
                                select new
                                {
                                    Nr = h.Nr,
                                    Navn = h.Navn,
            ...
            if (AntalForslag > 0)
            {
                ...
                foreach (var rstmedlem in memKont)
                {
                    ...
                    int next_faknr = p_dbData3060.nextval("faknr");
        ...
        public Tuple<int, int> kontingent_fakturer_bs1(dbData3060 p_dbData3060)
        {
            int lobnr;
            string wadvistekst = "";
            int winfotekst;
            ...
            bool? wbsh = (from h in p_dbData3060.tempKontforslag select h.bsh).First();
            bool bsh = (wbsh == null) ? false : (bool)wbsh;
            string wDelsystem;
            if (bsh) wDelsystem = "BSH";
            else wDelsystem = "BS1";
            ...
            var rstmedlems = from k in p_dbData3060.tblMedlem
                             join l in p_dbData3060.tempKontforslaglinie on k.Nr equals l.Nr
                             join h in p_dbData3060.tempKontforslag on l.Kontforslagid equals h.id
                             select new
                             {
                                 k.Nr,
                                 k.Navn,
        ...
        public void rykker_email(dbData3060 p_dbData3060, int lobnr)
        {
            int wleveranceid;
            int? wSaveFaknr;
            ...
            var rstdebs = from k in p_dbData3060.tblMedlem
                          join r in p_dbData3060.tblrykker on k.Nr equals r.Nr
                          where r.tilpbsid == lobnr && r.Nr != null
                          join f in p_dbData3060.tblfak on r.faknr equals f.faknr
                          orderby r.faknr
                          select new clsRstdeb
        ...
        public void faktura_og_rykker_601_action(dbData3060 p_dbData3060, int lobnr, fakType fakryk)
        {
            string rec;
            //lintype lin;
            //infolintype infolin;
            ...
            if (fakryk == fakType.fdfaktura) //KONTINGENT FAKTURA
            {
                ...
                rstdebs = from k in p_dbData3060.tblMedlem
                          join f in p_dbData3060.tblfak on k.Nr equals f.Nr
        ...
        public void sendAdvisRykkerEmail(dbData3060 p_dbData3060, string ToName, string ToAddr, string subject, string body)
        {
