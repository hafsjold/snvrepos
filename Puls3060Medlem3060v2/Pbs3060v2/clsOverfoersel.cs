...
namespace nsPbs3060v2
{
    ...
    {
        public Tuple<int, int> kreditor_fakturer_os1(dbData3060 p_dbData3060)
        {
            int lobnr;
            string wadvistekst;
            int wantalfakturaer;
            ...
            var rstmedlems = from k in p_dbData3060.tblMedlem
                             join l in p_dbData3060.tempBetalforslaglinie on k.Nr equals l.Nr
                             join h in p_dbData3060.tempBetalforslag on l.Betalforslagid equals h.id
                             select new
                             {
                                 k.Nr,
                                 k.Navn,
        ...
        public void krdfaktura_overfoersel_action(dbData3060 p_dbData3060, int lobnr)
        {
            string rec;
            int seq = 0;
            int wleveranceid;
            ...
            {
                var antal = (from c in p_dbData3060.tbloverforsel
            ...
            tblkreditor krd = (from k in p_dbData3060.tblkreditor
            ...
            var qrydeb = from h in p_dbData3060.tbloverforsel
        ...
        public void overfoersel_mail(dbData3060 p_dbData3060, int lobnr)
        {
            var antal = (from c in p_dbData3060.tbltilpbs
                         where c.id == lobnr
                         select c).Count();
