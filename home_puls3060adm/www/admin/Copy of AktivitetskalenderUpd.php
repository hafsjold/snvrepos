      ...
      <td width="350"> 
        ...
        <input type="hidden" name="KLinieDato_old" value="<?=$KLinieDato?>">
          ...
          <tr> 
            ...
            <td width="275"> 
              <textarea name="KLinieText" cols="25" rows="4"><?=$KLinieText?></textarea>
          ...
          <tr> 
            ...
            <td width="275"> 
              <textarea name="KLinieSted" cols="25" rows="4"><?=$KLinieSted?></textarea>
      ...
      <? if ($DoWhat == 3) { // Vis record ?>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td width="75" valign="top">Aktivitet</td>
            <td width="275"> 
              <textarea name="KLinieText" cols="50" rows="4">
              	<?=$KLinieText?>
              </textarea>
      ...
      <? } else { // Vis record med fejl ?>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td width="75" valign="top">Aktivitet</td>
            <td width="275"> 
              <textarea name="KLinieText" cols="50" rows="4"><?=$_POST["KLinieText"]?></textarea>
            </td>
