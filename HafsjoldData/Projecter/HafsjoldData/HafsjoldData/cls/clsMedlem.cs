...
namespace nsHafsjoldData
{
    public partial class clsMedlem
    {
        ...
        public clsMedlem(string pCsvString)
        {
            ...
            clsCsv.MedlemFieldUpdate += new nsHafsjoldData.clsCsv.MedlemFieldUpdateHandler(On_MedlemFieldUpdate);
        ...
        public string getNewCvsString()
        {
            ...
            clsCsv.MedlemCsvStringUpdate += new nsHafsjoldData.clsCsv.MedlemFieldUpdateHandler(On_MedlemCsvStringUpdate);
            ParseCsvString(ref m_Csv);
            clsCsv.MedlemCsvStringUpdate -= new nsHafsjoldData.clsCsv.MedlemFieldUpdateHandler(On_MedlemCsvStringUpdate);
